...
<ul>
    ...
    <li>Your use of any information or materials on this website is entirely at your own risk. We shall not be liable for any consequences arising from such use. It is your responsibility to ensure that any home insurance products or information obtained from this website meet your specific requirements.</li>
</ul>
...
<p>We reserve the right to revise these terms and conditions at any time without prior notice. Your continued use of this website constitutes acceptance of the then-current version of these terms and conditions.</p>
        ...
        <div class="buttons">
            <a href="form3.php?policyName=<?php echo urlencode($_GET['policyName']); ?>&basicPremium=<?php echo urlencode($_GET['basicPremium']); ?>"><button class="btn red-btn">ACCEPT</button></a>
