    ...
    <form action="agent.php" method="post">
         <div class="input-box">
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder=" " name="age" readonly>
                </div>
                    <?php

if (!empty($clientInfoRow["DOB"])) {
...
<div class="input-box">
        ...
        <input type="date" name="sd" required id="start-date"><br><br />
        </div>
        ...
        document.getElementById("image").innerText = captcha;
    }

    
    function printmsg(event) {
        event.preventDefault(); 
        var captchaInput = document.getElementById("submit").value;
        var captchaImage = document.getElementById("image").innerText;

        if (captchaInput === captchaImage) {
            document.getElementById("key").innerText = "Captcha verified.";
        } else {
            document.getElementById("key").innerText = "Captcha does not match. Please try again.";
        }
    }
        </script>
